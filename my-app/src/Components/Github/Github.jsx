...
function Github(){
    ...
    <img align="center" width={"40%"}  src="https://github-readme-streak-stats.herokuapp.com/?user=Rsaikiran92&ring=76263f&fire=76263f&currStreakLabel=76263f"  alt="rsaikiran92" />
    </div>
    </div>
)
}
